...
\exercise $0.5cm \quad x=0.5cos(\pi t+\pi)$
...
\exercise $0.05\rm{m}\quad -\arccos{\frac{3}{5}}$
...
\solve
（1）加速度$a=\frac{F}{m}=-2x$，因此角频率$\omega=\sqrt{\frac{a}{-x}}=\sqrt{2}$，故周期为$T=\frac{2\pi}{\omega}=\sqrt{2}\pi$。\par
（2）由于动能的最大值等于势能的最大值，有：$E_{动max}=E_{势max}=\frac{1}{2}kA^2=0.0675$J
