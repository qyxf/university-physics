...
$$
\begin{aligned} \sqrt {\bar{v^{2}}} & = \sqrt { \frac { 3 k T } { u } } \\ u O _ { 2 } & > u H _ { 2 } \\ \sqrt {\bar{v^{2}}  \left(\ce{O2}\right) } & = \sqrt { \bar { v } ^ { 2 } \left( H _ { 2 } \right) } \\ T \left( O _ { 2 } \right) & > T \left( H _ { 2 } \right) \end{aligned}
$$
...
$$
\begin{array} { c }\bar{\varepsilon}_{\mbox{平}}=\frac{3}{2}kT \\
 = \frac { 3 } { 2 } \times 1.38 \times 10^{- 23 } \times 300 = 6.21 \times 10 ^ { - 21 } \\
 {\bar{\varepsilon }_ { \mbox{转}} = k T = 4.14 \times 10 ^ { - 21 } } \end{array}
$$
