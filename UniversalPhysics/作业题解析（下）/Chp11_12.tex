...
\section{计算题}
\exercise{11}$\frac{1}{2}(\frac{C}{V_1^2}-\frac{C}{V_2^2})$或$\frac{1}{2}(P_1V_1-P_2V_2)$\qquad 减少\qquad 放热
...
\exercise{16}$7.82 \times 10 ^ { 7 } s ^ { - 1 } \qquad5 \times 10 ^ { - 5 } \mathrm { cm }$
...
\exercise{19}$\geqslant 0 $\qquad 不变 \qquad 增
